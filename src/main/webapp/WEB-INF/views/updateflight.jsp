...
<section class="home-content ">
    <div class="content">
        ...
        <div class="container pt-5 d-flex flex-column justify-content-center align-items-center">
            <h2 class="text-white mb-3 ">Uçuş Kaydı Güncelleme</h2>

            <form value="${item.fromLocation}" action="/flight/update" method="post"
                ...
                <select value="${item.toFrom}" required class="form-select mt-2" aria-label="Nereye" name="toFrom">
                    <option selected>Nereden</option>
                    <option value="sivas">Sivas</option>
                    <option value="kayseri">Kayseri</option>
                    <option value="ankara">Ankara</option>
                ...
                <input value="${item.date}" required class="form-control mt-2" type="date" name="date"/>
                <input value="${item.price}" required class="form-control mt-2" placeholder="Fiyat" type="number"
                       name="price"/>
                ...
                %>
                <p class="text-white">Uçuş kaydınız başarıyla alınmıştır.</p>
